    ...
    companion object{
        fun getGames(context: Context): ArrayList<Game> {
            ...
            games.add(Game(
                ...
                4.8f,
                listOf(
                    Console(1, "Super Nintendo", "Nintendo", "2010-11-29"),
                    Console(2, "GBA", "Nintendo", "2010-11-29"),
                    Console(1, "Nintendo DS", "Nintendo", "2010-11-29"),
                    Console(1, "Playstation", "Sony", "2010-11-29")
                ))
            )
